...
let recargaTiktokPendente = null;
function agendarRecargaTiktok() {
  // várias entradas podem ficar visíveis quase juntas (scroll rápido) —
  // isso junta tudo numa recarga só, em vez de recarregar o script várias
  // vezes seguidas
  clearTimeout(recargaTiktokPendente);
  recargaTiktokPendente = setTimeout(reloadTiktokEmbedScript, 150);
}
...
function carregarEmbedSeVisivel(item) {
  ...
  if (item.dataset.plataforma === "tiktok") agendarRecargaTiktok();
